...
export class DiscoveryDisplay {
    ...
    update(deltaTime) {
        ...
        this.discoveries = this.discoveries.filter(discovery => currentTime - discovery.timestamp < this.displayDuration);
        // Remove expired notifications
        this.notifications = this.notifications.filter(notification => currentTime - notification.timestamp < this.notificationDuration);
    }
