...
describe('StellarMap System', () => {
  ...
  // Planet size and color calculation tests removed - now internal to PlanetRenderer
  // Planet rendering behavior is tested through integration tests in "Planet Rendering" section
